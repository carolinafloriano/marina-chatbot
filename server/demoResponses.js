// Respostas simuladas para o "modo demo" — permite testar toda a interface
// (histórico, indicador de "a escrever", nova conversa, etc.) sem chamar a
// API da Anthropic e sem qualquer custo. Ativado com DEMO_MODE=true no .env.
//
// Isto NÃO é o comportamento real da Marina — é apenas correspondência de
// palavras-chave, sem qualquer modelo de linguagem por trás. Serve só para
// desenvolvimento local da interface.
